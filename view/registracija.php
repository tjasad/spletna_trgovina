...
<form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
  <div>
    ...
    <input type="text" placeholder="Vnesite priimek" name="surname" id = "priimek" value="<?= $surname ?>" required><br/>
    <label for="naslov"><b>Naslov</b></label>
    <input type="text" placeholder="Vnesite ulico" name="street" id = "naslov" value="<?= $street ?>" required>
    <input type="text" placeholder="Vnesite hišno številko" name="house_number" value="<?= $house_number ?>" required>
    <input type="text" placeholder="Vnesite pošto" name="post" value="<?= $post ?>" required>
    <input type="text" placeholder="Vnesite poštno številko" name="post_number" value="<?= $post_number ?>" /><br/>
    <label for="email"><b>Epošta</b></label>
    <input type="email" placeholder="Vnesite epoštni naslov" name="email" id="email" value="<?= $email ?>"/><br/>
    <label for="geslo"><b>Geslo</b></label>
    <input type="password" placeholder="Vnesite izbrano geslo" name="password" id = "geslo" value="<?= $password ?>" required><br/>
