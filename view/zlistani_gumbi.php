...
<html> 
    ...
    <body>
        ...
        <h3><b>(tudi stranka, prodajalec, admin) Splošen view: </b><h3><br>
                <ul>
                    <li>
                        <div>
        ...
        <h3><b>(tudi prodajalec, admin) Stranka view: </b><h3><br>
                <ul>
                    <li>
                        <div>
        ...
        <h3><b>(tudi admin)Prodajalec view: </b><h3><br>
        ...
        <h3><b>Administrator view: </b><h3><br>
                <ul>
                    <li>                        
                        <div>
