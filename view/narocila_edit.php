...
<div>
    ...
    <form action="<?= BASE_URL . "seminarska_naloga/ne_obdelana_narocila-edit" ?>" method="post">
        <div>
            ...
            <input type="text" placeholder="Vnesite id naročila" name="order_id" id="order_id"
                   value="<?= $articel["order_id"] ?>" required><br/>
            <label for="article_name"><b>Id stranke</b></label>
            <input type="text" placeholder="Vnesite id stranke" name="costumer_id" id="costumer_id"
                   value="<?= $articel["costumer_id"] ?>" required><br/>
            <label for="article_price"><b>Skupna cena</b></label>
            <input type="text" placeholder="Vnesite skupno ceno" name="total_price" id="total_price"
