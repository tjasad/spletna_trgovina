...
1. Najprej se naložijo podatki za podatkovno bazo. Ti se nahajajo v datoteki trgovina.sql

        mysql -u root -p NetBeansProjects/spletna_trgovina/conf/trgovina.sql
